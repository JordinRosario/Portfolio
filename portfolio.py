...
def send_email(name,email,message):
    mi_email='jordinjose2003@gmail.com'
    ...
    html_content = '''
    <p> Hola Jordin, tienes un nuevo contacto de la web: </p>
    <p>Nombre: -name-</p>
    <p>Correo: -email-</p>
    <p>Mensaje: -message-</p>
    '''
    mail = Mail(email, to_email, 'Nuevo contacto desde la web', html_content = html_content)
